...
def generate_index(global_skills: List[Dict], local_skills: List[Dict], include_global: bool = False) -> str:
    ...
    # Only add auto-generated comment if including global skills
    # (Local-only mode produces cleaner output for open-source repos)
    if include_global:
        lines.append("*(Auto-generated by skills-index-updater SKILL - do not edit manually)*")
        lines.append("")
